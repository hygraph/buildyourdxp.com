      ...
      --> */}
            ...
            <main className="mt-10 mx-auto max-w-screen-xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
              <div className="sm:text-center lg:text-left">
                ...
                <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                  An open source catalogue to explore the best-of-breed services
                  that power today's{" "}
                  <span className="text-primary">
                    Digital Experience Platforms
                  </span>
                  , enabling teams to deliver exceptional customer experiences
                  at scale.
                </p>
        ...
        <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
          <img
            ...
            src="https://images.unsplash.com/photo-1525540810550-5032f5d191b1?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2551&q=80"
            alt=""
          />
        </div>
      </div>
        ...
        <div className="max-w-screen-xl mx-auto">
          <div className="relative pt-6 px-4 sm:px-6 lg:px-8">
            <div className="md:flex -mx-6">
              <div className="md:w-1/5 px-6">Yo</div>
